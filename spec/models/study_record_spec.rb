  ...
  describe '学習記録新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'start_timeが未来の日時であれば登録できない' do
        ...
        @study_record.end_clock = ''
        @study_record.start_time = @study_record.start_time.change(year: tomorrow_date.year,
      ...
      it '既に同一user同一日付の学習記録が登録されている場合は登録できない' do
        ...
        another_study_record.start_time = another_study_record.start_time.change(year: same_date.year,
                                                                                 month: same_date.month, day: same_date.day)
